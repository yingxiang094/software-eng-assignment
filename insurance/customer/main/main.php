                ...
                <div class="row">
                    <div class="col-md-8 offset-md-2">
                        <div class="profile-card">
                            <h2 class="mb-4">Welcome, <?php echo htmlspecialchars($userInfo['customerEmail']); ?>!</h2>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <ul class="list-unstyled">
                                        <li class="mb-2">
                                            <strong>Email: </strong>
                                            <?php echo htmlspecialchars($userInfo['customerEmail']); ?>
                                        </li>
                                        <li class="mb-2">
                                            <strong>Password: </strong>
                                            <?php echo htmlspecialchars($userInfo['customerPassword']); ?>
                                        </li>
                                    </ul>
                                </div>
                                <div class="col-md-6">
