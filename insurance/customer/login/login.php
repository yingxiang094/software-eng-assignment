...
if ($_SERVER["REQUEST_METHOD"] == "POST")  {     
    $ctmEmail = $_POST['customerEmail'];     
    $ctmPassword = $_POST['customerPassword'];           
    ...
    if ($result->num_rows == 1) {         
        ...
        if($ctmPassword == $row['customerPassword']) {             
            $_SESSION['customerEmail'] = $ctmEmail;              
            header("Location: ../main/main.php");              
            exit();         
        } else {           
    ...
    <div class="login-container">
        ...
        <form method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>">
            <div class="form-group">
                <input type="text" class="form-control" name="customerEmail" placeholder="User ID" required>
            </div>
            <div class="form-group">
