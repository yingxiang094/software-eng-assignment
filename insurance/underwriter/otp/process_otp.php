...
if (isset($_POST['send_otp'])) {
    ...
    $check_email_stmt = $conn->prepare("SELECT underwriterEmail FROM underwriter WHERE underwriterEmail = ?");
    ...
    $stmt = $conn->prepare("INSERT INTO underwriter_otp (email, otp, created_at, expires_at) VALUES (?, ?, ?, ?)");
