...
if (isset($_POST['savebtn']))
{
    ...
    $checkEmail = "select * from underwriter where underwriterEmail = ?";
    ...
    {
        $stmt = $conn->prepare("insert into underwriter(underwriterEmail,underwriterPassword)values(?,?)");
    ...
    <div class="registration-container">
        ...
        <form action="" method="post">
            <div class="form-group">
                ...
                <input type="email" class="form-control" name="underwriterEmail" 
                       value="<?php echo $_SESSION['verified_email']; ?>" disabled>
            </div>
            <div class="form-group">
                <label class="form-label">Password: </label> 
                <input type="password" class="form-control" name="underwriterPassword" 
