...
if (isset($_POST['send_otp'])) {
    ...
    $check_email_stmt = $conn->prepare("SELECT agentEmail FROM agent WHERE agentEmail = ?");
    ...
    $stmt = $conn->prepare("INSERT INTO agent_otp (email, otp, created_at, expires_at) VALUES (?, ?, ?, ?)");
