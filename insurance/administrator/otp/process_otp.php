...
if (isset($_POST['send_otp'])) {
    ...
    $check_email_stmt = $conn->prepare("SELECT administratorEmail FROM administrator WHERE administratorEmail = ?");
    ...
    $stmt = $conn->prepare("INSERT INTO administrator_otp (email, otp, created_at, expires_at) VALUES (?, ?, ?, ?)");
